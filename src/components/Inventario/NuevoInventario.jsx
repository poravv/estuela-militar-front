...
function NuevoInventario({ token, idsucursal }) {
    ...
    const agregarLista = async (e) => {
        ...
        if (productoSelect === null) {
            message.error('Vuelva a seleccionar un parte');
            return false;
        }
        ...
        if (validExist.length !== 0) {
            message.error('La parte ya existe en la lista');
            return false;
        }
                ...
                <Form
                    ...
                    <Row style={{ justifyContent: `center`, margin: `10px` }}>
                        <Col style={{ marginLeft: `15px` }}>
                            <Buscador label={'descripcion'} title={'Parte'} value={'idproducto'} data={productos} onChange={onChange} onSearch={onSearch} />
                        </Col>
                        <Col style={{ marginLeft: `15px` }}>
