...
function NuevoProductoFinal({ token, idusuario }) {
    ...
    const agregarLista = async (e) => {
        ...
        try {
            ...
            setMensaje('Seleccione una parte')
            setTimeout(() => {
                setMensaje(null)
            }, 8000);
        }
        ...
        if (articuloSelect !== null) {
            if (cantidad !== 0 && cantidad !== null && cantidad !== '') {
                if (validExist.length === 0) {
                    ...
                    setMensaje('La parte ya existe en la lista')
                    setTimeout(() => {
                        setMensaje(null)
                    }, 8000);
                }
            ...
            setMensaje('Selecciona una parte')
            setTimeout(() => {
                setMensaje(null)
            }, 5000);
        }
            ...
            <div>
                <Form
                    ...
                    <Row style={{ justifyContent: `center`, margin: `10px` }}>
                        <Col style={{ marginLeft: `15px` }}>
                            <Buscador label={'descripcion'} title={'Parte'} value={'idproducto'} data={producto} onChange={onChange} onSearch={onSearch} />
                        </Col>
                        <Col style={{ marginLeft: `15px` }}>
